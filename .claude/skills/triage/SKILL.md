---
name: triage
description: Process your inbox. Fetches unread emails, categorises them by urgency, and drafts replies for approval. Use when the user says "triage", "check emails", "help with inbox", or "process emails".
argument-hint: or "triage --query 'from:investor'"
---
...
If the user provided a custom query (e.g. `/triage --query 'from:investor'`), pass it through:
