---
name: meeting-prep
description: Prepare for an upcoming meeting. Pulls calendar details, searches emails and Drive for context, and creates a briefing. Use when the user says "prep for", "prepare for", "meeting prep", or "brief me on".
